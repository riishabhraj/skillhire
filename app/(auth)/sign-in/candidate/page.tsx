        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="text-lg text-muted-foreground">
              Continue your job search and showcase your skills through project-based opportunities.
            </p>
          </div>
          ...
          <div className="rounded-lg border border-border bg-muted/30 p-6">
            ...
            <p className="text-sm text-muted-foreground">
              Track your applications, manage your projects, and discover new opportunities tailored to your skills.
            </p>
          </div>
        </div>
          ...
          <div className="w-full max-w-md">
            <div className="mb-6 text-center">
              ...
              <p className="text-sm text-muted-foreground mt-2">
                Access your candidate dashboard and continue your job search.
              </p>
            </div>
